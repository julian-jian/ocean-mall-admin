...
<!--            <span class="font-small">品牌：{{scope.row.productBrand}}</span>-->
        ...
        <el-table-column label="属性" width="180" align="center">
          <template slot-scope="scope">{{scope.row.productAttr|formatAttr}}</template>
        </el-table-column>
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          <el-col :span="6" class="form-border form-left-bg font-small">申请退款单号</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.returnOrderSn}}</el-col>
        </el-row>
        <el-row>
      ...
      <div class="form-container-border">
        ...
        <el-row v-if="orderReturnApply.returnStatus">
          <el-col class="form-border form-left-bg font-small" :span="6">申请退款金额</el-col>
          <el-col class="form-border font-small" :span="18">￥{{orderReturnApply.refoundAmount}}</el-col>
        </el-row>
        <el-row>
        ...
        <div v-if="orderReturnApply.status!==3 && orderReturnApply.returnStatus != 1">
        <el-row>
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{currentAddress == null ? "" : currentAddress.name}}</el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{currentAddress == null ? "" : currentAddress.detailAddress}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">联系电话</el-col>
          <el-col class="form-border font-small" :span="18">{{currentAddress == null ? "" : currentAddress.phone}}</el-col>
        </el-row>
        <el-row v-show="orderReturnApply.returnStatus === 0">
          <el-col class="form-border form-left-bg font-small" :span="6">退货单号</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.returnMailNumber}}</el-col>
        </el-row>
        </div>
      </div>
      <div class="form-container-border" v-show="orderReturnApply.status!==0">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.handleTime}}</el-col>
        </el-row>
        <el-row>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===2">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.receiveTime
            }}</el-col>
        </el-row>
        <el-row>
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===0 && orderReturnApply.returnStatus === 0">
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===0 && orderReturnApply.returnStatus == 1">
        <el-button type="primary" size="small" @click="handleUpdateStatus(2)">确认退款</el-button>
...
<script>
  ...
  export default {
    ...
    filters: {
      ...
      formatAttr(attr) {
        let attr1 = JSON.parse(attr);
        let str = "";
        for(var p in attr1) {
          str = str + attr1[p].key + ":" +attr1[p].value + ",";
        }
    ...
    methods: {
      ...
      handleUpdateStatus(status){
        ...
        if (status == 2) {
          this.$confirm('是否要进行此操作?此操作后款项会原路返回,不可更改', '提示', {
          ...
          if (this.updateStatusParam == null || this.updateStatusParam.companyAddressId == null) {
            this.$confirm('请选择退货地址', '提示', {
              confirmButtonText: '确定',
              cancelButtonText: '取消',
              type: 'warning'
            })
