      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">
            <el-tooltip class="item" effect="light" :content="order | formatAddress" placement="bottom">
...
<!--            <p>品牌：{{scope.row.productBrand}}</p>-->
      ...
      <div class="table-layout">
        ...
        <el-row>
          ...
          <el-col :span="6" class="table-cell">-￥{{order.useIntegration}}</el-col>
        </el-row>
        <el-row>
    ...
    <logistics-dialog v-model="logisticsDialogVisible" :orderId="this.order.id * 1"></logistics-dialog>
  </div>
</template>
<script>
  import {getOrderDetail,updateReceiverInfo,updateMoneyInfo,closeOrder,updateOrderNote,deleteOrder,cancelOrder} from '@/api/order';
