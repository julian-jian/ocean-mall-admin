<template>
  <el-card class="form-container" shadow="never">
    <el-form :model="productCate"
      ...
      <el-form-item v-if="productCate.parentId==0" label="是否参与折扣：">
        <el-radio-group v-model="productCate.participationDiscount">
          <el-radio :label="1">是</el-radio>
          <el-radio :label="0">否</el-radio>
        </el-radio-group>
      </el-form-item>
<!--      <el-form-item label="是否显示在首页导航栏：">-->
<!--        <el-radio-group v-model="productCate.navStatus" :disabled="productCate.parentId">-->
<!--          <el-radio :label="1">是</el-radio>-->
<!--          <el-radio :label="0">否</el-radio>-->
<!--        </el-radio-group>-->
<!--      </el-form-item>-->
  ...
  export default {
    ...
    methods: {
      getSelectProductCateList() {
        fetchList(0, {pageSize: 1000, pageNum: 1}).then(response => {
