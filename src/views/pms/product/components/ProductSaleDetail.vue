<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productSaleForm" label-width="140px" style="width: 600px" size="small">
...
<!--      </el-form-item>-->
      <el-form-item label="是否可以积分换购：">
        <el-switch
          v-model="value.verifyStatus"
          :active-value="1"
          :inactive-value="0">
        </el-switch>
      </el-form-item>
<!--      <el-form-item label="所需积分数量：">-->
<!--        <el-input v-model="value.usePointLimit" :disabled="value.verifyStatus == 1 ? false:true"></el-input>-->
<!--      </el-form-item>-->
...
<!--          :inactive-value="0">-->
<!--        </el-switch>-->
<!--        <span style="margin-left: 10px;margin-right: 10px">珊瑚盐珊瑚粮专区</span>-->
<!--        <el-switch-->
...
<!--&lt;!&ndash;          <el-radio-button :label="2">会员价格</el-radio-button>&ndash;&gt;-->
