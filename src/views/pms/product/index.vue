...
<!--          </el-form-item>-->
          <el-form-item label="上架状态：">
            <el-select v-model="listQuery.publishStatus" placeholder="全部状态" clearable>
              <el-option
...
<!--            </p>-->
        ...
        <el-table-column label="SKU库存" width="140" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="积分换购" align="center">
          <template slot-scope="scope">
            <p>{{scope.row.verifyStatus | verifyStatusFilter}}</p>
<!--            <p>{{ [scope.row.verifyStatus, scope.row.usePointLimit] | pointFilter}}</p>-->
<!--            <p>-->
<!--              <el-button-->
<!--                type="text"-->
    ...
    <el-dialog
      ...
      <el-table style="width: 100%;margin-top: 20px"
        ...
        <el-table-column
          ...
          align="center">
          <template slot-scope="scope">
            <el-input v-model="scope.row.giftPoints"></el-input>
          </template>
        </el-table-column>
        <el-table-column
          v-if="editSkuInfo.verifyStatus"
          label="兑换积分"
          width="100"
          align="center">
          <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      handleShowSkuEditDialog(index,row){
        ...
        this.editSkuInfo.verifyStatus = row.verifyStatus;
